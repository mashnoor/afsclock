                        ...
                        <ul class="nav navbar-nav ml-auto navmenu">
                            <li class="nav-item">
                                <div class="ui pointing link dropdown item" tabindex="0">
                                    ...
                                    <div class="menu" tabindex="-1">
                                      ...
                                      <a href="{{ url('employees/new') }}" class="item"><i class="ui icon user plus"></i> New Employee</a>
                                      <div class="divider"></div>
                            ...
                            <li class="nav-item">
                               <div class="ui pointing link dropdown item" tabindex="0">
                                    ...
                                    <i class="dropdown icon"></i>
                                    <div class="menu" tabindex="-1">
                                      <a href="{{ url('update-profile') }}" class="item"><i class="ui icon user"></i> Update Account</a>
