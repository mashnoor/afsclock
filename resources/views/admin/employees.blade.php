@extends('layouts.default')
    ...
    @section('meta')
        <title>Employees | Attendance Keepert</title>
        <meta name="description" content="Attendance Keepert employees, view all employees, add, edit, delete, and archive employees.">
    @endsection
