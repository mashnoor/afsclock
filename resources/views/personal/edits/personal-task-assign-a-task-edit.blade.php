            ...
            <div class="col-md-12">
                <div class="box box-success">
                    <div class="box-content">
                        ...
                        @endif
                        <form id="edit_task_form" action="{{ url('personal/tasks/assignatask/update') }}" class="ui form" method="post" accept-charset="utf-8">
                            @csrf
                            <div class="field">
                                <label>Assigned To</label>
                                <input type="text" name="assigned_to" class="readonly" readonly="" value="@isset($task->assignedTo){{ $task->assignedTo->firstname }} {{ $task->assignedTo->lastname }}@endisset">
                            </div>

                            <div class="field">
                                <label>Title</label>
                                <input type="text" name="title"  value="@isset($task->title){{ $task->title }}@endisset">
                            </div>
                            <div class="fields">
                                <div class="sixteen wide field">
                                    <label>Description</label>
                                    <textarea class="" rows="5" name="description">@isset($task->description){{ $task->description }}@endisset</textarea>
                                </div>
                            </div>
                    ...
                    <div class="box-footer">
                        ...
                        <a class="ui grey small button" href="{{ url('taskmanagement') }}"><i class="ui times icon"></i> Cancel</a>
                    </div>
                    </form>
                </div>
            </div>
